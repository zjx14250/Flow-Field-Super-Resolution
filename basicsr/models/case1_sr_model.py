"""Custom SR Model for 2-channel case1 data."""
import numpy as np
import torch
from basicsr.models.sr_model import SRModel
from basicsr.utils import imwrite, tensor2img
from basicsr.utils.constants import CASE1_MAX, CASE1_MEAN, CASE1_MIN, CASE1_STD
...
NORM_MEAN = CASE1_MEAN  # Average mean across cu/zhong/xi/chao
NORM_STD = CASE1_STD    # Average std across cu/zhong/xi/chao
DATA_MIN = CASE1_MIN    # Global min from all datasets
DATA_MAX = CASE1_MAX    # Global max from all datasets


@MODEL_REGISTRY.register()
class Case1SRModel(SRModel):
    """SR model for 2-channel scientific data (case1).
